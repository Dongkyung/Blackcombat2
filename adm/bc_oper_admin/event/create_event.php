...
$sql = "INSERT INTO blackcombat.tb_event (event_category, `order`, event_name, event_name_short, event_place, event_date, selling_yn, sell_url, max_img_idx, prologue, lsttm) VALUES ('$event_category', $order, '$event_name','$event_name_short','$event_place', '$event_date', $selling_yn, '$sell_url', $max_img_idx, '$prologue', now())";
echo $sql;
