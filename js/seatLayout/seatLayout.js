...
(function ($) {
    function Movieseat(_paramObject) {
        ...
        var getMainLayoutFunc = function (_obj) {
            ...
            var actionPanel = pluginOptions.showActionButtons?"<div class='seat-proccess-panel'> <button  type='button' class='layout-action-btn layout-btn-cancel  "+ pluginOptions.classes.cancelBtn +"'>닫기</button> <button type='button' class='layout-action-btn layout-btn-done "+ pluginOptions.classes.doneBtn +"'>선택</button> </div>":"";
