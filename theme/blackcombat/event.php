...
<style>
    ...
    .event_category .custom_btn:hover{
                        ...
                        ?>
                            <li style="width:100%; border-top: 1px solid #bbbbbb; padding:10px">
                                <div style="display:flex;">
                                    <div style="flex:1 1 80px;"><img style="width:100%; height:180px; object-fit: contain; " src="<?php echo G5_THEME_IMG_URL; ?>/event/<?= $row["event_seq"] ?>/thumb.jpg" /></div>
