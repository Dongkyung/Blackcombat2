...
<?php } else if ($page == 'flyweight_3') { ?>
    ...
    <div class="fighter_info">
        <div class="fighter_data">
            ...
            <div class="fighter_match">
                ...
                <div class="match_list">
                    <ul>
                        <li>
                            <span class="match_result win">Win</span> 김성웅 vs 이강남
                        </li>
                    </ul>
                </div>
            </div>
        ...
        <div class="fighter_img">
            <img src="<?php echo G5_THEME_IMG_URL; ?>/fighter/fighter_viper_chap_full.png" />
        </div>
    </div>
        ...
        <div class="fighter_data">
            ...
            <div class="fighter_match">
                ...
                <div class="match_list">
                    <ul>
                        <li>
                            <span class="match_result win">Win</span> 성낙중 vs 정도한
                        </li>
                    </ul>
                </div>
            </div>
        ...
        <div class="fighter_data">
            ...
            <div class="fighter_match">
                ...
                <div class="match_list">
                    <ul>
                        <li>
                            <span class="match_result win">Win</span> 박석광 vs 전우주
                        </li>
                    </ul>
                </div>
            </div>
...
<?php } else if ($page == 'flyweight_short_hair_lee') { ?>
    ...
    <div class="fighter_info">
        ...
        <div class="fighter_img">
            <img src="<?php echo G5_THEME_IMG_URL; ?>/fighter/fighter_full_pirateking.png" />
        </div>
    </div>
...
<?php } else if ($page == 'flyweight_alsdnx') { ?>
    ...
    <div class="fighter_info">
        <div class="fighter_data">
            ...
            <div class="data_name">
                김민우
                <span class="data_ringname">"매드독"</span>
                <span class="data_age">AGE 24</span>
            </div>
            <div class="sns_link">
                <a href="https://www.instagram.com/alsdnx_x/" target="_blank">@alsdnx_x</a>
            </div>
            <div class="data_team">
                팀명 : 마이티짐
            </div>
        ...
        <div class="fighter_img">
            <img src="<?php echo G5_THEME_IMG_URL; ?>/fighter/fighter_full_alsdnx.png" />
        </div>
    </div>

<?php } else if ($page == 'flyweight_wooju') { ?>
    ...
    <div class="fighter_info">
        <div class="fighter_data">
            ...
            <div class="data_name">
                전우주
                <span class="data_ringname">"더 스페이스"</span>
                <span class="data_age">AGE 16</span>
            </div>
            <div class="sns_link">
                <a href="https://www.instagram.com/wooju_0101/" target="_blank">@wooju_0101</a>
            </div>
            <div class="data_team">
                팀명 : 팀 피니쉬
            </div>
...
<?php } else if ($page == 'flyweight_hoyoung') { ?>
        ...
        <div class="fighter_data">
            ...
            <div class="fighter_match">
                ...
                <div class="match_list">
                    <ul>
                        <li>
                            <span class="match_result win">Win</span> 윤호영 vs 조호제
                        </li>
                    </ul>
                </div>
            </div>
...
<?php } else if ($page == 'flyweight_komakine') { ?>
    ...
    <div class="fighter_info">
        <div class="fighter_data">
            ...
            <div class="data_name">
                코마키네 타카히로
                <span class="data_ringname">"탱크"</span>
                <span class="data_age">AGE 32</span>
            </div>
            <div class="sns_link">
                <a href="https://www.instagram.com/komakine_t/" target="_blank">@komakine_t</a>
            </div>
            <div class="data_team">
                팀명 : CRAZY ARMAMENT
            </div>
            ...
            <div class="fighter_match">
                ...
                <div class="match_list">
                    <ul>
                        <li>
                            <span class="match_result win">Win</span> 코마키네 타카히로 vs 김성웅
                        </li>
                    </ul>
                </div>
            </div>
        ...
        <div class="fighter_data">
            ...
            <div class="fighter_match">
                ...
                <div class="match_list">
                    <ul>
                        <li>
                            <span class="match_result win">Win</span> 유수영 vs 이시즈카 코이치
                        </li>
                    </ul>
                </div>
            </div>
...
<?php } else if ($page == 'bantamweight_jjin_honge') { ?>
        ...
        <div class="fighter_data">
            ...
            <div class="fighter_match">
                ...
                <div class="match_list">
                    <ul>
                        <li>
                            <span class="match_result win">Win</span> 박성준 vs 홍종태
                        </li>
                    </ul>
                </div>
            </div>
        ...
        <div class="fighter_data">
            ...
            <div class="fighter_match">
                ...
                <div class="match_list">
                    <ul>
                        <li>
                            <span class="match_result win">Win</span> 김주환 vs 하준혁
                        </li>
                    </ul>
                </div>
            </div>
...
<?php } else if ($page == 'bantamweight_sung_j') { ?>
...
<?php } else if ($page == 'bantamweight_joohwan') { ?>
    ...
    <div class="fighter_info">
        <div class="fighter_data">
            ...
            <div class="data_name">
                김주환
                <span class="data_ringname">"땅꾼"</span>
                <span class="data_age">AGE 30</span>
            </div>
            <div class="sns_link">
                <a href="https://www.instagram.com/joohwan__kim/" target="_blank">@joohwan__kim</a>
            </div>
            <div class="data_team">
                팀명 : 더짐랩
            </div>
...
<?php } else if ($page == 'bantamweight_domestic') { ?>
    ...
    <div class="fighter_info">
        <div class="fighter_data">
            ...
            <div class="data_name">
                이시즈카 코이치
                <span class="data_ringname">"도메스틱 프린스"</span>
                <span class="data_age">AGE 36</span>
            </div>
            <div class="sns_link">
                <!-- <a href="https://www.instagram.com/joohwan__kim/" target="_blank">@joohwan__kim</a> -->
        ...
        <div class="fighter_data">
            ...
            <div class="fighter_match">
                ...
                <div class="match_list">
                    <ul>
                        <li>
                           <span class="match_result win">Win</span> 아오이 진 vs 신승민
                        </li>
                    </ul>
                </div>
            </div>
...
<?php } else if ($page == 'featherweight_10') { ?>
    ...
    <div class="fighter_info">
        <div class="fighter_data">
            ...
            <div class="fighter_match">
                ...
                <div class="match_list">
                    <ul>
                        <li>
                            <span class="match_result win">Win</span> 조규준 vs 지혁민
                        </li>
                    </ul>
                </div>
            </div>
        ...
        <div class="fighter_img">
            <img src="<?php echo G5_THEME_IMG_URL; ?>/fighter/fighter_baki_full.png" />
        </div>
    </div>
<?php } else if ($page == 'chuncheon_king') { ?>
    ...
    <div class="fighter_info">
        <div class="fighter_data">
            ...
            <div class="data_name">
                지혁민
                <span class="data_ringname">"춘천대장"</span>
                <span class="data_age">AGE 18</span>
            </div>
            <div class="sns_link">
                <a href="https://www.instagram.com/jhm.721/" target="_blank">@jhm.721</a>
            </div>
            <div class="data_team">
                팀명 : 춘천 팀매드
            </div>
        ...
        <div class="fighter_img">
            <img src="<?php echo G5_THEME_IMG_URL; ?>/fighter/fighter_chuncun_full.png" />
        </div>
    </div>
...
<?php } else if ($page == 'featherweight_finisher') { ?>
    ...
    <div class="fighter_info">
        <div class="fighter_data">
            ...
            <div class="sns_link">
                <a href="https://www.instagram.com/finisher_hwang/" target="_blank">@finisher_hwang</a>
            </div>
            <div class="data_team">
                팀명 : 블랙리스트MMA
            </div>
            ...
            <div class="fighter_match">
                ...
                <div class="match_list">
                    <ul>
                        <li>
                            <span class="match_result win">Win</span> 황준호 vs 문병일
                        </li>
                    </ul>
                </div>
            </div>
...
<?php } else if ($page == 'featherweight_byeong') { ?>
    ...
    <div class="fighter_info">
        <div class="fighter_data">
            ...
            <div class="data_name">
                문병일
                <span class="data_ringname">"VIOLENT"</span>
                <span class="data_age">AGE 28</span>
            </div>
            <div class="sns_link">
                <a href="https://www.instagram.com/_byeong.1_moon/" target="_blank">@_byeong.1_moon</a>
            </div>
            <div class="data_team">
                팀명 : 1TIER GYM
            </div>
...
<?php } else if ($page == 'featherweight_aoi_jin') { ?>
    ...
    <div class="fighter_info">
        <div class="fighter_data">
            ...
            <div class="data_name">
                아오이 진
                <span class="data_ringname">"블루데빌"</span>
                <span class="data_age">AGE 26</span>
            </div>
            <div class="sns_link">
                <!-- <a href="https://www.instagram.com/_byeong.1_moon/" target="_blank">@_byeong.1_moon</a> -->
        ...
        <div class="fighter_data">
            ...
            <div class="fighter_match">
                ...
                <div class="match_list">
                    <ul>
                        <li>
                            <span class="match_result win">Win</span> 이송하 vs 오하라 주리
                        </li>
                    </ul>
                </div>
            </div>
        ...
        <div class="fighter_data">
            ...
            <div class="fighter_match">
                ...
                <div class="match_list">
                    <ul>
                        <li>
                            <span class="match_result win">Win</span> 박종헌 vs 조준용
                        </li>
                    </ul>
                </div>
            </div>
        ...
        <div class="fighter_data">
            ...
            <div class="fighter_match">
                ...
                <div class="match_list">
                    <ul>
                        <li>
                            <span class="match_result win">Win</span> 조준용 vs 장정혁
                        </li>
                    </ul>
                </div>
            </div>
...
<?php } else if ($page == 'lightweight_26') { ?>
    ...
    <div class="fighter_info">
        <div class="fighter_data">
            ...
            <div class="fighter_match">
                ...
                <div class="match_list">
                    <ul>
                        <li>
                            <span class="match_result win">Win</span> 오하라 주리 vs 이환성
                        </li>
                    </ul>
                </div>
            </div>
        ...
        <div class="fighter_img">
            <img src="<?php echo G5_THEME_IMG_URL; ?>/fighter/fighter_ubermensch_full.png" />
        </div>
    </div>
...
<?php } else if ($page == 'lightweight_superchoi') { ?>
    ...
    <div class="fighter_info">
        <div class="fighter_data">
            ...
            <div class="data_name">
                최성욱
                <span class="data_ringname">"아기고릴라"</span>
                <span class="data_age">AGE 36</span>
            </div>
            <div class="sns_link">
                <a href="https://www.instagram.com/superchoi87/" target="_blank">@superchoi87</a>
            </div>
            <div class="data_team">
                팀명 : 케이레슬링
            </div>
            ...
            <div class="fighter_match">
                ...
                <div class="match_list">
                    <ul>
                        <li>
                            <span class="match_result win">Win</span> 최성욱 vs 김석민
                        </li>
                    </ul>
                </div>
            </div>
...
<?php } else if ($page == 'lightweight_kim_mma') { ?>
    ...
    <div class="fighter_info">
        <div class="fighter_data">
            ...
            <div class="data_name">
                김석민
                <span class="data_ringname">"마우이"</span>
                <span class="data_age">AGE 28</span>
            </div>
            <div class="sns_link">
                <a href="https://www.instagram.com/_kim_mma/" target="_blank">@_kim_mma</a>
            </div>
            <div class="data_team">
                팀명 : 김석민 TEAM MMA짐
            </div>
        ...
        <div class="fighter_img">
            <img src="<?php echo G5_THEME_IMG_URL; ?>/fighter/fighter_maui_full.png" />
        </div>
    </div>


<?php } else if ($page == 'lightweight_juriohara') { ?>
    ...
    <div class="fighter_info">
        <div class="fighter_data">
            ...
            <div class="data_name">
                오하라 주리
                <span class="data_ringname">"아이언 스파이더"</span>
                <span class="data_age">AGE 32</span>
            </div>
            <div class="sns_link">
                <a href="https://www.instagram.com/juriohara/" target="_blank">@juriohara</a>
            </div>
            <div class="data_team">
                팀명 : KIBA Martial Arts Club
            </div>
            <div class="data_bio">
                <div class="data_bio_height">
                    <div class="mini">HEIGHT</div>
            ...
            <div class="data_record">
                ...
                <div class="data_record_draw">
                    19 <div class="mini">Lose</div>
                </div>
                <div class="data_record_lose">
                    3 <div class="mini">Draw</div>
                </div>
            </div>
            <div class="fighter_match">
                <div class="match_title">
        ...
        <div class="fighter_img">
            <img src="<?php echo G5_THEME_IMG_URL; ?>/fighter/fighter_juri_full.png" />
        </div>
    </div>


<?php } else if ($page == 'middle_shingo_suzuki') { ?>
    ...
    <div class="fighter_info">
        <div class="fighter_data">
            ...
            <div class="data_name">
                스즈키 신고
                <span class="data_ringname">"선더버드"</span>
                <span class="data_age">AGE 37</span>
            </div>
            <div class="sns_link">
                <a href="https://www.instagram.com/_shingo_suzuki_/" target="_blank">@_shingo_suzuki_</a>
            </div>
            <div class="data_team">
                팀명 : ALLIANCE
            </div>
            ...
            <div class="data_record">
                <div class="data_record_win">
                    13 <div class="mini">Win</div>
                </div>
                <div class="data_record_draw">
                    14 <div class="mini">Lose</div>
                </div>
                <div class="data_record_lose">
                    2 <div class="mini">Draw</div>
                </div>
            ...
            <div class="fighter_match">
                ...
                <div class="match_list">
                    <ul>
                        <li>
                           <span class="match_result win">Win</span> 최준서 vs 스즈키 신고
                        </li>
                    </ul>
                </div>
            </div>
        ...
        <div class="fighter_data">
            ...
            <div class="fighter_match">
                ...
                <div class="match_list">
                    <ul>
                        <li>
                           <span class="match_result win">Win</span> 양해준 vs 시카이 료
                        </li>
                    </ul>
                </div>
            </div>
...
<?php } else if ($page == 'rocky') { ?>
    <div class="fighter_info">
        <div class="fighter_data">
            ...
            <div class="data_name">
                록키 마르티네즈
                <span class="data_ringname">"CHAMP"</span>
                <span class="data_age">AGE 37</span>
            </div>
            <div class="sns_link">
                <a href="https://www.instagram.com/roque_martinez86/" target="_blank">@roque_martinez86</a>
            </div>
            <div class="data_team">
                팀명 : RM SPORTS
            </div>
            ...
            <div class="fighter_match">
                ...
                <div class="match_list">
                    <ul>
                        <li>
                        <span class="match_result win">Win</span> 록키 마르티네즈 vs 아즈자르갈
                        </li>
                    </ul>
                </div>
            </div>
        ...
        <div class="fighter_img">
            <img src="<?php echo G5_THEME_IMG_URL; ?>/fighter/figher_rocky_full.png" />
        </div>
    </div>
...
<?php } else if ($page == 'heavyweight_5') { ?>
    ...
    <div class="fighter_info">
        ...
        <div class="fighter_img">
            <img src="<?php echo G5_THEME_IMG_URL; ?>/fighter/figher_aza_full.png" />
        </div>
    </div>
        ...
        <div class="fighter_data">
            ...
            <div class="fighter_match">
                ...
                <div class="match_list">
                    <ul>
                        <li>
                            <span class="match_result win">Win</span> 최재현 vs 박찬솔
                        </li>
                    </ul>
                </div>
            </div>
...
<?php } else if ($page == 'heavyweight_21') { ?>
    ...
    <div class="fighter_info">
        <div class="fighter_data">
            ...
            <div class="sns_link">
                <a href="https://www.instagram.com/blacklist__7 /" target="_blank">@blacklist__7 </a>
            </div>
            <div class="data_team">
                팀명 : 펭카 큐브 MMA
            </div>
...
<?php } else if ($page == 'heavyweight_sikai_ryo') { ?>
    ...
    <div class="fighter_info">
        <div class="fighter_data">
            ...
            <div class="data_name">
                사카이 료
                <span class="data_ringname">"레이징불"</span>
                <span class="data_age">AGE 36</span>
            </div>
            <div class="sns_link">
                <a href="https://www.instagram.com/ryo.19870324/" target="_blank">@ryo.19870324</a>
            </div>
            <div class="data_team">
                팀명 : Paraestra Matsudo
            </div>
            <div class="data_bio">
                <div class="data_bio_height">
                    <div class="mini">HEIGHT</div>
        ...
        <div class="fighter_data">
            ...
            <div class="fighter_match">
                ...
                <div class="match_list">
                    <ul>
                        <li>
                            <span class="match_result win">Win</span> 박시윤 vs 오시마 사오리
                        </li>
                    </ul>
                </div>
            </div>
...
<?php } else if ($page == 'women_1114saori') { ?>
    ...
    <div class="fighter_info">
        <div class="fighter_data">
            ...
            <div class="data_name">
                오시마 사오리
                <span class="data_ringname">"리틀 자이언트"</span>
                <span class="data_age">AGE 29</span>
            </div>
            <div class="sns_link">
                <a href="https://www.instagram.com/1114saori/" target="_blank">@1114saori</a>
            </div>
            <div class="data_team">
                팀명 : AACC
            </div>
        ...
        <div class="fighter_img">
            <img src="<?php echo G5_THEME_IMG_URL; ?>/fighter/fighter_1114saori_full.png" />
        </div>
    </div>
