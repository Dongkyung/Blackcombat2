                ...
                <div class="ranking_list">
                    ...
                    <div class="ranking_list_part">
                        ...
                        <div class="ranking_list_part_item" onclick="location.href='<?php echo G5_URL ?>/fighter.php?page=flyweight_10';">
                            ...
                            <div class="ranking_list_name">조효제<span class="ring_name">버서커 / 익스트림 익스트림컴뱃</span></div>
                            <div class="ranking_list_change">NEW</div>
                        </div>
                    ...
                    <div class="ranking_list_part">
                        ...
                        <div class="ranking_list_part_item" onclick="location.href='<?php echo G5_URL ?>/fighter.php?page=bantamweight_11';">
                            ...
                            <div class="ranking_list_name">이명주<span class="ring_name">컴뱃산타 / 익스트림 익스트림컴뱃</span></div>
                            <div class="ranking_list_change">-</div>
                        </div>
                        ...
                        <div class="ranking_list_part_item" onclick="location.href='<?php echo G5_URL ?>/fighter.php?page=bantamweight_13';">
                            ...
                            <div class="ranking_list_name">박태호<span class="ring_name">앤쵸비 / 익스트림 익스트림컴뱃</span></div>
                            <div class="ranking_list_change">NEW</div>
                        </div>
                    ...
                    <div class="ranking_list_part">
                        <div class="ranking_list_part_champ" onclick="location.href='<?php echo G5_URL ?>/fighter.php?page=featherweight_champ';">
                        ...
                        <div class="ranking_list_part_item" onclick="location.href='<?php echo G5_URL ?>/fighter.php?page=featherweight_12';">
                            ...
                            <div class="ranking_list_name">최재원<span class="ring_name">동키콩 / 익스트림 익스트림컴뱃</span></div>
                            <div class="ranking_list_change">-</div>
                        </div>
                    ...
                    <div class="ranking_list_part">
                        <div class="ranking_list_part_champ"  onclick="location.href='<?php echo G5_URL ?>/fighter.php?page=lightweight_champ';">
                            ...
                            <div class="ranking_champ_name">
                                이송하
                                <div class="ranking_ring_name">피에로 / 알타핏 싸비MMA</div>
                            </div>
                            <div class="ranking_champ_photo">
                        ...
                        <div class="ranking_list_part_item" onclick="location.href='<?php echo G5_URL ?>/fighter.php?page=lightweight_16';">
                            ...
                            <div class="ranking_list_name">장근영<span class="ring_name">슬로스 / 아리에블랙 MMA스토리</span></div>
                            <div class="ranking_list_change">▼ 1</div>
                        </div>
                        <div class="ranking_list_part_item" onclick="location.href='<?php echo G5_URL ?>/fighter.php?page=lightweight_17';">
                            ...
                            <div class="ranking_list_name">신준호<span class="ring_name">웨어울프 / 익스트림 익스트림컴뱃</span></div>
                            <div class="ranking_list_change">NEW</div>
                        </div>
                        ...
                        <div class="ranking_list_part_item" onclick="location.href='<?php echo G5_URL ?>/fighter.php?page=lightweight_25';">
                            ...
                            <div class="ranking_list_name">허니허니<span class="ring_name">격노사 / 아리에 블랙 MMA 스토리</span></div>
                            <div class="ranking_list_change">▼ 2</div>
                        </div>
                    </div>
                    <div class="ranking_list_part">
                        ...
                        <div class="ranking_list_part_item" onclick="location.href='<?php echo G5_URL ?>/fighter.php?page=heavyweight_5';">
                            ...
                            <div class="ranking_list_name">아즈자르갈<span class="ring_name">AZZA / 익스트림 익스트림컴뱃</span></div>
                            <div class="ranking_list_change">NEW</div>
                        </div>
                        ...
                        <div class="ranking_list_part_item" onclick="location.href='<?php echo G5_URL ?>/fighter.php?page=heavyweight_13';">
                            ...
                            <div class="ranking_list_name">이현성<span class="ring_name">원펀맨 / 익스트림 익스트림컴뱃</span></div>
                            <div class="ranking_list_change">▼ 1</div>
                        </div>
