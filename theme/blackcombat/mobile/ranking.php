            ...
            <div class="ranking_page">
                ...
                <div class="ranking_list">
                    ...
                    <div class="ranking_list_part">
                        ...
                        <div class="ranking_list_part_item" onclick="location.href='<?php echo G5_URL ?>/fighter.php?page=bantamweight_0';">
                            <div class="ranking_list_num">7</div>
                            <div class="ranking_list_photo">
                        ...
                        <div class="ranking_list_part_item" onclick="location.href='<?php echo G5_URL ?>/fighter.php?page=bantamweight_8';">
                            <div class="ranking_list_num">8</div>
                            <div class="ranking_list_photo">
                                <img src="<?php echo G5_THEME_IMG_URL; ?>/fighter_bbadda.png">
                            </div>
                        ...
                        <div class="ranking_list_part_item" onclick="location.href='<?php echo G5_URL ?>/fighter.php?page=bantamweight_parksanghyun_mma';">
                            <div class="ranking_list_num">10</div>
                            <div class="ranking_list_photo">
                                <img src="<?php echo G5_THEME_IMG_URL; ?>/fighter_parksanghyun.png">
                            </div>
                            <div class="ranking_list_name">박상현<span class="ring_name">빡상 / 아리에 블랙 MMA 스토리</span></div>
                            <div class="ranking_list_change">-</div>
                        </div>
                        <div class="ranking_list_part_item" onclick="location.href='<?php echo G5_URL ?>/fighter.php?page=bantamweight_jjin_honge ';">
                            <div class="ranking_list_num">11</div>
                            <div class="ranking_list_photo">
                                <img src="<?php echo G5_THEME_IMG_URL; ?>/fighter_jjinhonge.png">
                            </div>
                            <div class="ranking_list_name">홍종태<span class="ring_name">찐홍이 / 아리에 블랙 MMA 스토리</span></div>
                            <div class="ranking_list_change">-</div>
                        </div>
                        <div class="ranking_list_part_item" onclick="location.href='<?php echo G5_URL ?>/fighter.php?page=seigo ';">
                            <div class="ranking_list_num">12</div>
                            <div class="ranking_list_photo">
                                <img src="<?php echo G5_THEME_IMG_URL; ?>/fighter_blank.png">
                            </div>
                            <div class="ranking_list_name">야마모토 세이고<span class="ring_name">Little SexYama / -</span></div>
                            <div class="ranking_list_change">New</div>
                        </div>
                        <div class="ranking_list_part_item" onclick="location.href='<?php echo G5_URL ?>/fighter.php?page=bantamweight_joohwan';">
                            <div class="ranking_list_num">13</div>
                            <div class="ranking_list_photo">
                                <img src="<?php echo G5_THEME_IMG_URL; ?>/fighter_blank.png">
                            </div>
                            <div class="ranking_list_name">김주환<span class="ring_name">땅꾼 / 더짐랩</span></div>
                            <div class="ranking_list_change">▼ 1</div>
                        </div>
                        ...
                        <div class="ranking_list_part_item" onclick="location.href='<?php echo G5_URL ?>/fighter.php?page=bantamweight_sung_j';">
                            <div class="ranking_list_num">15</div>
                            <div class="ranking_list_photo">
                                <img src="<?php echo G5_THEME_IMG_URL; ?>/fighter_blank.png">
                            </div>
                            <div class="ranking_list_name">이성재<span class="ring_name">포세이돈 / 아리에 블랙 MMA 스토리</span></div>
                            <div class="ranking_list_change">▼ 1</div>
                        </div>
                        ...
                        <div class="ranking_list_part_item" onclick="location.href='<?php echo G5_URL ?>/fighter.php?page=bantamweight_13';">
                            <div class="ranking_list_num">17</div>
                            <div class="ranking_list_photo">
                                <img src="<?php echo G5_THEME_IMG_URL; ?>/fighter_8ouruniverse8.png">
                            </div>
                            <div class="ranking_list_name">박태호<span class="ring_name">앤쵸비 / Extreme 익스트림 컴뱃</span></div>
                            <div class="ranking_list_change">▼ 1</div>
                        </div>
                        <div class="ranking_list_part_item" onclick="location.href='<?php echo G5_URL ?>/fighter.php?page=bantamweight_kim_suhyunn';">
                            <div class="ranking_list_num">18</div>
                            <div class="ranking_list_photo">
                                <img src="<?php echo G5_THEME_IMG_URL; ?>/fighter_blank.png">
                            </div>
                            <div class="ranking_list_name">김수현<span class="ring_name">아이언 / Extreme 익스트림 컴뱃</span></div>
                            <div class="ranking_list_change">▼ 1</div>
                        </div>
                        ...
                        <div class="ranking_list_part_item" onclick="location.href='<?php echo G5_URL ?>/fighter.php?page=bantamweight_taeyeongan';">
                            <div class="ranking_list_num">22</div>
                            <div class="ranking_list_photo">
                                <img src="<?php echo G5_THEME_IMG_URL; ?>/fighter_blank.png">
                            </div>
                        ...
                        <div class="ranking_list_part_item" onclick="location.href='<?php echo G5_URL ?>/fighter.php?page=bantamweight_thediamond';">
                            <div class="ranking_list_num">26</div>
                            <div class="ranking_list_photo">
                                <img src="<?php echo G5_THEME_IMG_URL; ?>/fighter_blank.png">
                            </div>
                            <div class="ranking_list_name">박재석<span class="ring_name">더 다이아몬드 / Extreme 익스트림 컴뱃</span></div>
                            <div class="ranking_list_change">▼ 1</div>
                        </div>
                        <div class="ranking_list_part_item" onclick="location.href='<?php echo G5_URL ?>/fighter.php?page=bantamweight_27';">
                            <div class="ranking_list_num">27</div>
                            <div class="ranking_list_photo">
                                <img src="<?php echo G5_THEME_IMG_URL; ?>/fighter_blank.png">
                            </div>
                            <div class="ranking_list_name">차범준<span class="ring_name">빌런차 / 지브라 칼슨 해적단</span></div>
                            <div class="ranking_list_change">▼ 1</div>
                        </div>
                        <div class="ranking_list_part_item" onclick="location.href='<?php echo G5_URL ?>/fighter.php?page=bantamweight_25';">
                            <div class="ranking_list_num">28</div>
                            <div class="ranking_list_photo">
                                <img src="<?php echo G5_THEME_IMG_URL; ?>/fighter_blank.png">
                            </div>
                        ...
                        <div class="ranking_list_part_item" onclick="location.href='<?php echo G5_URL ?>/fighter.php?page=bantamweight_28';">
                            <div class="ranking_list_num">32</div>
                            <div class="ranking_list_photo">
                                <img src="<?php echo G5_THEME_IMG_URL; ?>/fighter_blank.png">
                            </div>
                            <div class="ranking_list_name">이예준<span class="ring_name">몬스터 블랙 / BF 팀 솔리드</span></div>
                            <div class="ranking_list_change">▼ 1</div>
                        </div>
                    ...
                    <div class="ranking_list_part">
                        <div class="ranking_list_part_champ" onclick="location.href='<?php echo G5_URL ?>/fighter.php?page=featherweight_3';">
                            ...
                            <div class="ranking_champ_name">
                                ...
                                <div class="ranking_ring_name">대구 쎈짐</div>
                            </div>
                            <div class="ranking_champ_photo">
                                <img src="<?php echo G5_THEME_IMG_URL; ?>/fighter_gwangnam.png">
                            </div>
                        </div>
                        <div class="ranking_list_part_item" onclick="location.href='<?php echo G5_URL ?>/fighter.php?page=featherweight_aoi_jin';">
                            <div class="ranking_list_num">1</div>
                            <div class="ranking_list_photo">
                                <img src="<?php echo G5_THEME_IMG_URL; ?>/fighter_blank.png">
                            </div>
                        ...
                        <div class="ranking_list_part_item" onclick="location.href='<?php echo G5_URL ?>/fighter.php?page=nakamura';">
                            <div class="ranking_list_num">6</div>
                            <div class="ranking_list_photo">
                                <img src="<?php echo G5_THEME_IMG_URL; ?>/fighter_blank.png">
                            </div>
                            <div class="ranking_list_name">나카무라 다이스케<span class="ring_name">다이 하드 스피릿 / Yutsukido Honpo</span></div>
                            <div class="ranking_list_change">New</div>
                        </div>
                        ...
                        <div class="ranking_list_part_item" onclick="location.href='<?php echo G5_URL ?>/fighter.php?page=featherweight_chan_mma';">
                            ...
                            <div class="ranking_list_name">손유찬<span class="ring_name">천안짱 / 천안 크레이지광짐</span></div>
                            <div class="ranking_list_change">▼ 1</div>
                        </div>
                        <div class="ranking_list_part_item" onclick="location.href='<?php echo G5_URL ?>/fighter.php?page=featherweight_jeju_psychopitbulls';">
                            ...
                            <div class="ranking_list_name">이성철<span class="ring_name">겜블러 / 제주 싸이코핏불스</span></div>
                            <div class="ranking_list_change">▼ 1</div>
                        </div>
                        <div class="ranking_list_part_item" onclick="location.href='<?php echo G5_URL ?>/fighter.php?page=featherweight_seonghyeok_0227';">
                            ...
                            <div class="ranking_list_name">최성혁<span class="ring_name">키라 / 팀한 클럽</span></div>
                            <div class="ranking_list_change">▼ 1</div>
                        </div>
                        ...
                        <div class="ranking_list_part_item" onclick="location.href='<?php echo G5_URL ?>/fighter.php?page=featherweight_shyeok_01';">
                            ...
                            <div class="ranking_list_name">방성혁<span class="ring_name">시라소니 / Extreme 익스트림 컴뱃</span></div>
                            <div class="ranking_list_change">▼ 1</div>
                        </div>
                        ...
                        <div class="ranking_list_part_item" onclick="location.href='<?php echo G5_URL ?>/fighter.php?page=featherweight_revenant';">
                            ...
                            <div class="ranking_list_name">이민혁<span class="ring_name">레버넌트 / Extreme 익스트림 컴뱃</span></div>
                            <div class="ranking_list_change">▼ 1</div>
                        </div>
                    ...
                    <div class="ranking_list_part">
                        <div class="ranking_list_part_champ" onclick="location.href='<?php echo G5_URL ?>/fighter.php?page=heavyweight_1';">
                            <h3><span class="weight">미들급</span> <span class="champ">CHAMPION</span></h3>
                            <div class="ranking_champ_name">
                                최원준
                                <div class="ranking_ring_name">화이트 베어</div>
                                <div class="ranking_ring_name">아리에 블랙 MMA 스토리</div>
                            </div>
                            <div class="ranking_champ_photo">
                                <img src="<?php echo G5_THEME_IMG_URL; ?>/fighter_j_mma_middle.png">
                            </div>
                        </div>
                        <div class="ranking_list_part_item" onclick="location.href='<?php echo G5_URL ?>/fighter.php?page=heavyweight_4';">
                            ...
                            <div class="ranking_list_name">최준서<span class="ring_name">야차 / BF 팀 솔리드</span></div>
                            <div class="ranking_list_change">-</div>
                        </div>
                    ...
                    <div class="ranking_list_part">
                        <div class="ranking_list_part_champ" onclick="location.href='<?php echo G5_URL ?>/fighter.php?page=heavyweight_0';">
                            ...
                            <div class="ranking_champ_name">
                                양해준
                                <div class="ranking_ring_name">The Big Guy</div>
                                <div class="ranking_ring_name">Extreme 익스트림 컴뱃</div>
                            </div>
                            <div class="ranking_champ_photo">
                                <img src="<?php echo G5_THEME_IMG_URL; ?>/fighter_yang_hae_jun.png">
                            </div>
                        </div>
                        <div class="ranking_list_part_item" onclick="location.href='<?php echo G5_URL ?>/fighter.php?page=heavyweight_1';">
                            <div class="ranking_list_num">1</div>
                            <div class="ranking_list_photo">
                                <img src="<?php echo G5_THEME_IMG_URL; ?>/fighter_j_mma.png">
                            </div>
                        ...
                        <div class="ranking_list_part_item" onclick="location.href='<?php echo G5_URL ?>/fighter.php?page=heavyweight_sikai_ryo';">
                            <div class="ranking_list_num">4</div>
                            <div class="ranking_list_photo">
                                <img src="<?php echo G5_THEME_IMG_URL; ?>/fighter_blank.png">
                            </div>
                        ...
                        <div class="ranking_list_part_item" onclick="location.href='<?php echo G5_URL ?>/fighter.php?page=heavyweight_22';">
                            ...
                            <div class="ranking_list_name">윤재웅<span class="ring_name">잇뽕 / 아리에 블랙 MMA 스토리</span></div>
                            <div class="ranking_list_change">-</div>
                        </div>
                        ...
                        <div class="ranking_list_part_item" onclick="location.href='<?php echo G5_URL ?>/fighter.php?page=heavyweight_10';">
                            <div class="ranking_list_num">10</div>
                            <div class="ranking_list_photo">
                                <img src="<?php echo G5_THEME_IMG_URL; ?>/fighter_limjnwook.png">
                            </div>
                            <div class="ranking_list_name">임진욱<span class="ring_name">베놈 / 아리에블랙 MMA 스토리</span></div>
                            <div class="ranking_list_change">-</div>
                        </div>
                        <div class="ranking_list_part_item" onclick="location.href='<?php echo G5_URL ?>/fighter.php?page=heavyweight_24';">
                            <div class="ranking_list_num">11</div>
                            <div class="ranking_list_photo">
                                <img src="<?php echo G5_THEME_IMG_URL; ?>/fighter_blank.png">
                            </div>
                            <div class="ranking_list_name">전호철<span class="ring_name">팩맨 / 지브라 칼슨 해적단</span></div>
                            <div class="ranking_list_change">-</div>
                        </div>
                        ...
                        <div class="ranking_list_part_item" onclick="location.href='<?php echo G5_URL ?>/fighter.php?page=heavyweight_15';">
                            ...
                            <div class="ranking_list_name">박용정<span class="ring_name">DaddyP / BF 팀 솔리드</span></div>
                            <div class="ranking_list_change">-</div>
                        </div>
                        ...
                        <div class="ranking_list_part_item" onclick="location.href='<?php echo G5_URL ?>/fighter.php?page=heavyweight_17';">
                            ...
                            <div class="ranking_list_name">신정민<span class="ring_name">마린복서 / BF 팀 솔리드</span></div>
                            <div class="ranking_list_change">-</div>
                        </div>
                        ...
                        <div class="ranking_list_part_item" onclick="location.href='<?php echo G5_URL ?>/fighter.php?page=heavyweight_19';">
                            ...
                            <div class="ranking_list_name">이재규<span class="ring_name">5분의힘 / 스웰즈 코리아</span></div>
                            <div class="ranking_list_change">-</div>
                        </div>
                        <div class="ranking_list_part_item" onclick="location.href='<?php echo G5_URL ?>/fighter.php?page=heavyweight_wolverine';">
                            <div class="ranking_list_num">23</div>
                            <div class="ranking_list_photo">
                                <img src="<?php echo G5_THEME_IMG_URL; ?>/fighter_blank.png">
                            </div>
                            <div class="ranking_list_name">한주안<span class="ring_name">울버린 / 아리에 블랙 MMA 스토리</span></div>
                            <div class="ranking_list_change">-</div>
                        </div>
                        <div class="ranking_list_part_item" onclick="location.href='<?php echo G5_URL ?>/fighter.php?page=heavyweight_23';">
                            <div class="ranking_list_num">24</div>
                            <div class="ranking_list_photo">
                                <img src="<?php echo G5_THEME_IMG_URL; ?>/fighter_blank.png">
                            </div>
                        ...
                        <div class="ranking_list_part_item" onclick="location.href='<?php echo G5_URL ?>/fighter.php?page=heavyweight_25';">
                            ...
                            <div class="ranking_list_name">김승욱<span class="ring_name">마인부우 / BF 팀 솔리드</span></div>
                            <div class="ranking_list_change">-</div>
                        </div>
                        <div class="ranking_list_part_item" onclick="location.href='<?php echo G5_URL ?>/fighter.php?page=heavyweight_leedonghyun1';">
                            <div class="ranking_list_num">26</div>
                            <div class="ranking_list_photo">
                                <img src="<?php echo G5_THEME_IMG_URL; ?>/fighter_blank.png">
                            </div>
                    ...
                    <div class="ranking_list_part">
                        <div class="ranking_list_part_champ" onclick="location.href='<?php echo G5_URL ?>/fighter.php?page=women_siyoon';">
                            <h3><span class="weight">여성부</span> <span class="champ">CHAMPION</span></h3>
                            <div class="ranking_champ_name">
                                박시윤
                                <div class="ranking_ring_name">쌍칼</div>
                                <div class="ranking_ring_name">더짐랩</div>
                            </div>
                            <div class="ranking_champ_photo">
                                <img src="<?php echo G5_THEME_IMG_URL; ?>/fighter_siyoon.png">
                            </div>
                        </div>
                        <div class="ranking_list_part_item" onclick="location.href='<?php echo G5_URL ?>/fighter.php?page=women_1114saori';">
                            <div class="ranking_list_num">1</div>
                            <div class="ranking_list_photo">
                                <img src="<?php echo G5_THEME_IMG_URL; ?>/fighter_1114saori.png">
                            </div>
                            <div class="ranking_list_name">오시마 사오리<span class="ring_name">리틀 자이언트 / AACC</span></div>
                            <div class="ranking_list_change">NEW</div>
                        </div>
