...
본 대회사가 주최하는 대회에 참가하는 모든 선수들은 계체량 전까지 자신이 경기를 진행함에 있어서 아무런 문제가 없다 라는 진단서를 대회사 제출해야만 한다. 만약 어떠한 결함이 발견될 경우, 전문의를 통해 판단 후 대회사와 협의 후 경기 진행 여부를 결정한다.<br /><br />
...
- 상대 선수의 파이트 쇼츠 및 글러브 안에 손가락을 넣는 경우<br />
...
- 그라운드 공방 상황에서 상위 포지션 공격자가 반칙할 경우, 주의/경고 후 스탠딩에서 다시 경기를 진행한다.<br />
- 그라운드 공방 상황에서 하위 포지션 방어자가 반칙할 경우, 주의/경고 후 동일한 포지션에서 다시 경기를 진행한다.<br />
- 스포츠맨십에 반하는 선수의 악의적이고도 고의적인 반칙 행위는 '주의/경고' 없이 바로 실격패 처리될 수 있다.<br />
- 주심은 반칙을 당한 선수에게 충분한 휴식 시간을 제공한다. 그럼에도 해당 선수가 회복을 하지 못하면 주심 혹은 링닥터의 판단으로 경기를 중단할 수 있고 반칙을 한 선수는 반칙패로 처리된다.<br />
- 해당 선수가 경기에 불참하거나, 2KG 이상 계체 초과 실패 시, 패널티를 부여하고 실격패 처리한다.<br /><br />


<h3>제 9 조 배점 기준</h3>
- 모든 경기는 3명의 배심이 배점 기준에 따라 공정하게 판정한다.<br />
- 배점 기준 1순위는 상태에게 큰 데미지를 주거나 압도적인 타격 혹은 압도적인 그라운드 컨트롤 및 서브미션 캐치를 가져간 경우, 2순위는 효과적인 타격 횟수(유효타), 테이크 다운 횟수나 그라운드 컨트롤 시간이며, 3순위는 어그레시브이다.<br />
...
(2) 제 9 조 배점 기준에 의거하여 최종적으로 더 높은 점수를 획득한 선수가 승리한다.<br />
(3) 블랙컴뱃은 매 경기의 마지막 라운드에 비중을 더 많이 두고 판정을 한다.<br />
(4) 3라운드 배점 이후, 무승부이거나, 세 명의 배심 중 한 명 이상의 배심이 연장전을 가야 한다고 채점한 경우, 전체 심판진과 기록원(총 8명)이 모여 연장전 여부를 협의할 수 있다. 협의 이후 무기명 투표를 통해 4명 이상의 투표자가 연장전을 동의할 경우, 연장전 1라운드를 추가 진행한다.<br />
