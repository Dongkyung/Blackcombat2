    ...
    <div class="sub_content">
        <div class="sub_container">
            <div class="rules_page">
                <span>2024.4.8 최종 수정</span><br><br>
...
<여성부> <br />
(1) 48.2kg 이하 : 아톰급 (Atomweight Division)<br /><br />
...
4. 블랙컴뱃 비긴즈<br />
: 아마추어, 세미프로 룰로 진행되어 세미프로, 선수 지망생 및 일반인의 참여가 가능한 대회로 두 달에 한 번씩 개최<br /><br />
...
- 알리 & 이노끼 상황에서 오블리킥을 제외한 모든 킥 공격 가능 (스탬핑킥, 싸커킥, 업킥 등)<br /><br />
...
- 유술, 레슬링 기술 등으로 상대방을 넘어뜨리고 등을 눕혀 유효 포지션/유리한 포지션을 3초 이상 점유한다면 테이크 다운 성공 및 그래플링 컨트롤 타임을 가져간 경우로 간주한다.<br>
