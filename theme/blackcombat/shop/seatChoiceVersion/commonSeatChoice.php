<div class="seat_choice_popup_wrap">
    <div class="seat_choice_popup_header">
        ...
        <? include_once(G5_THEME_PATH.'/shop/seatChoiceVersion/n12/seatChoice_n12.php'); ?>
    
    
    <div class="seat_choice_popup_footer">
        <a herf="#" class="seat_choice_popup_close_btn">닫기</a>
        <button type="button" class="seat_choice_btn" disabled>좌석 선택</button>
    </div>
</div>


    <? include_once(G5_THEME_PATH.'/shop/seatChoiceVersion/n12/script_n12.php'); ?>
