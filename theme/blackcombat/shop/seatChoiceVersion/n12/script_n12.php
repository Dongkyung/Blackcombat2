    ...
    (function ($) {
        ...
        if ($('#it_option_1').length) {
            $('#it_option_1 option').each(function() {
                ...
                if (objValue) {
                    if (objValue.indexOf('BLACKTINUM,319000') !== -1){ obj.attr('data-seat', 'BLACKTINUM'); }
                    else if (objValue.indexOf('VVIP,173000') !== -1){ obj.attr('data-seat', 'VVIP'); }
                    else if (objValue.indexOf('VIP,73000') !== -1){ obj.attr('data-seat', 'VIP'); }
                    else if (objValue.indexOf('GOLD,43000') !== -1){ obj.attr('data-seat', 'GOLD'); }
                    else if (objValue.indexOf('SILVER,13000') !== -1){ obj.attr('data-seat', 'SILVER'); }
                    else if (objValue.indexOf('GOLD(PKG),145200') !== -1){ obj.attr('data-seat', 'GOLD(PKG)'); }
                    else if (objValue.indexOf('SILVER(PKG),115500') !== -1){ obj.attr('data-seat', 'SILVER(PKG)'); }
                    else if (objValue.indexOf('STANDARD,0') !== -1){ obj.attr('data-seat', 'STANDARD'); }
                }
            });
        }
                            ...
                            $.ajax({
                                ...
                                success: function(data, textStatus) {
                                    ...
                                    if (data === 'Y'){
                                        ...
                                        if (rowType === 'BLACKTINUM-A' 
                                            || rowType === 'BLACKTINUM-B' 
                                            || rowType === 'BLACKTINUM-C' 
                                            || rowType === 'BLACKTINUM-D') {
                                        ...
                                        } else if (rowType === 'VVIP-B' 
                                            || rowType === 'VVIP-C' 
                                            || rowType === 'VVIP-F' 
                                            || rowType === 'VVIP-G') {
                                            selectedOptionObj = optionSelectObj.find('option[data-seat="VVIP"]').prop('selected', true);
                                        } else if (rowType === 'GOLD(PKG)') {
                                            selectedOptionObj = optionSelectObj.find('option[data-seat="GOLD(PKG)"]').prop('selected', true);
                                        } else if (rowType === 'SILVER(PKG)') {
                                            selectedOptionObj = optionSelectObj.find('option[data-seat="SILVER(PKG)"]').prop('selected', true);
                                        } else if (rowType === 'GOLD') {
                                            selectedOptionObj = optionSelectObj.find('option[data-seat="GOLD"]').prop('selected', true);
                                        } else if (rowType === 'SILVER') {
                                            selectedOptionObj = optionSelectObj.find('option[data-seat="SILVER"]').prop('selected', true);
