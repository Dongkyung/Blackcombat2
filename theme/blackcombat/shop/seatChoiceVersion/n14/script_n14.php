    ...
    (function ($) {
        ...
        if ($('#it_option_1').length) {
            $('#it_option_1 option').each(function() {
                ...
                if (objValue) {
                    if (objValue.indexOf('J/K GATE 212구역,100') !== -1){ obj.attr('data-seat', 'J/K GATE 212구역'); }
                    else if (objValue.indexOf('J/K GATE 211구역,200') !== -1){ obj.attr('data-seat', 'J/K GATE 211구역'); }
                            ...
                            $.ajax({
                                ...
                                success: function(data, textStatus) {
                                    ...
                                    if (data === 'Y'){
                                        ...
                                        if (rowType === 'J/K GATE 212구역' ) {
                                            selectedOptionObj = optionSelectObj.find('option[data-seat="J/K GATE 212구역"]').prop('selected', true);
                                        } else if (rowType === 'J/K GATE 211구역' ) {
                                            selectedOptionObj = optionSelectObj.find('option[data-seat="J/K GATE 211구역"]').prop('selected', true);
                                        }
