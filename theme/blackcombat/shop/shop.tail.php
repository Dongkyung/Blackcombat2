...
<!-- 하단 시작 { -->
    ...
    <div class="footer_copyright">
        <p style="padding-bottom:5px;">회사명 : 주식회사 이데아 파라</p>
...
<style>
    ...
    .seat_choice_popup_body {flex:0 0 auto; display:flex; flex-direction:column; align-items:flex-start; justify-content:flex-start; width:2200px; height:calc(100% - 130px); margin:0 auto; padding:10px 0; overflow-x:scroll; margin-top: 70px; /* 헤더 높이만큼 마진 */}
